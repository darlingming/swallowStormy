 ...
 * @date 2016-3-21
 */
public abstract class AbstractDataReducerFactroy implements AnalysisReducerInterface {

    /**
     *
     */
    private static final long serialVersionUID = 1L;
    private AbstractDoReducer doReducer;

    public AbstractDataReducerFactroy(AbstractDoReducer doReducer) {
